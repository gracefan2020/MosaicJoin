...
#SBATCH --output=wt-experiments/wt_query_results_embeddinggemma_D128_Q32_chamfer_top50/slurm_%a.out
#SBATCH --error=wt-experiments/wt_query_results_embeddinggemma_D128_Q32_chamfer_top50/slurm_%a.err
#SBATCH --array=0-11
#SBATCH --time=4:00:00
#SBATCH --mem=16G
...
python run_query_processing.py "datasets/wt/datalake_no_column_names" "wt-experiments/wt_offline_data_embeddinggemma_no_column_names/sketches_k128" "datasets/wt/wt_query_columns_no_column_names.csv" \
    --output-dir "wt-experiments/wt_query_results_embeddinggemma_D128_Q32_chamfer_top50/job_$SLURM_ARRAY_TASK_ID" \
    --top-k-return 50 \
