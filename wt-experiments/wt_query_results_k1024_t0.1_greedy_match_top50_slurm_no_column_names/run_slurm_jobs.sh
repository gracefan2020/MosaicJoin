...
#SBATCH --output=wt-experiments/wt_query_results_k1024_t0.1_greedy_matchtop50_slurm_no_column_names/slurm_%a.out
#SBATCH --error=wt-experiments/wt_query_results_k1024_t0.1_greedy_matchtop50_slurm_no_column_names/slurm_%a.err
#SBATCH --array=0-11
#SBATCH --time=4:00:00
#SBATCH --mem=16G
...
python run_query_processing.py "datasets/wt/datalake_no_column_names" "wt-experiments/wt_offline_data_no_column_names/sketches_k1024" "datasets/wt/wt_query_columns_no_column_names.csv" \
    --output-dir "wt-experiments/wt_query_results_k1024_t0.1_greedy_matchtop50_slurm_no_column_names/job_$SLURM_ARRAY_TASK_ID" \
    --top-k-return 50 \
